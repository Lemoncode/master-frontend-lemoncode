...
// A partir de 2015 con la llegada de ES6 podemos extender o agrupar los valores
// de los arrays gracias a los operadores "spread"/"rest".
...
// Cuando se hace "spread" de los items, se aplica una copia "poco profunda" o 
// "shallow copy", es decir, los objetos no se clonan, se pasan por referencia.
...
// También se pueden extender valores de una rray como argumentos
// de una función:
...
// El operador "rest" hace justo lo contrario que "spread", aunque su
// notación es la misma: agrupa argumentos en un array.
// Es decir, asigna todo los argumentos pasados a una funcion a elementos
// de un array. ¿Os acordáis de que las lambdas no tenían variable
// dinámica "arguments"? Se puede emular con el operador "rest":
const sum = (...nums) => nums.reduce((acc, num) => acc + num, 0);
console.log(sum()); // 0
console.log(sum(1, 2, 3)); // 6

// Cuando utilizamos "rest" podemos aislar argumentos iniciales y agrupar
// los restantes:
...
// A partir de ES9 (2018) podemos hacer "rest/srpead" también en propiedades de 
// objetos:
...
// De nuevo, la copia de propiedades es poco profunda o "shallow copy". No se
// clonan sino que se pasan por referencia.
const original = {
  name: "Evan",
  surname: "Smith",
  country: {
...
// Asi pues un cambio de "country" se refleja en ambos objetos,
// el original y la copia.
copy.country.id = 23;
console.log(original.country); // {id: 23,name: "Spain",iso3: "SPA"}
console.log(copy.country); // {id: 23,name: "Spain",iso3: "SPA"}

// Una combinación potente es aplicar "destructuring" y "rest"
// al mismo tiempo para aislar propiedades de objetos en argumentos
...
// Esto es útil para eliminar propiedades de objetos de forma inmutable,
// o dicho de forma llana, para quedarnos "con lo que nos interesa".