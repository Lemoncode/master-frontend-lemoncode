...
// -- Caso Práctico 1  --
const c3d: Coord3D = { // TS: Property 'z' is missing
  x: 3,
  y: 0
  // z: 5,
};
...
const calculateCommon = <A extends object, B extends object>(a: A, b: B)
  : Common<A, B> => {
  const result = { ...a };
  for (const key in a) {
...
// const calculateCommon2 = <A extends object, B extends object>(a: A, b: B)
//   : Common<A, B> =>
//   Object.fromEntries(
...
// PICK nos permite generar un sub-interfaz, a partir de un interfaz ya
...
// NonNullable genera un tipo nuevo a partir de otro, previniendo
