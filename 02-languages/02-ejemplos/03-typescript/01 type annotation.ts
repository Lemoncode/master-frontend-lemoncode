...
// por nosotros mismos, y decirle a TS, "oye, confia en mi, sé lo que hago".
// Volvamos al ejemplo del any:

const getData = () => { /*¿?*/ return "I am a string" };
let data: any = getData();

// Supongamos que alguien nos garantiza que getData devuelve siempre un string.
// En tal caso podríamos indicarle a TS que se fie de nosotros y tenga fe en que
// es un string mediante un casting.

console.log( data.substr(0) ); // Intellisense no funciona asi, porque data es de tipo any.
console.log( (data as string).substr(0) ); // Intellisense si funciona ahora, reconoce el tipo.
console.log( (<string>data).substr(1) ); // Intellisense si funciona ahora, reconoce el tipo.any.
