<template>
  <div class="flex flex-col min-h-[100dvh] items-stretch">
    ...
    <div class="flex flex-grow">
      ...
      <button aria-label="Resize sidebar" class="w-4 self-stretch bg-gray-700 hover:bg-gray-600 cursor-col-resize"
...
const onMouseDown = (event: MouseEvent) => {
  ...
  const startWidth = parseInt(sidebarStyles.value.width);
