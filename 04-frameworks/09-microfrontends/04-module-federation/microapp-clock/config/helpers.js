...
exports.bundleName = removeScopeInBundleName(process.env.npm_package_name); // @microapp/clock -> clock
exports.bundleNamePascalCase = pascalizeString(process.env.npm_package_name); // @microapp/clock -> MicroappClock
